...
export const DISCOVERY_FALLBACK_SOURCE_CATALOG: GrantDiscoverySourceEntry[] = [
  ...
  },
  {
    ...
    scope: 'NATIONAL',
    jurisdiction: 'CA',
    sourceUrl: 'https://www.cmhc-schl.gc.ca/consumers/home-buying/mortgage-loan-insurance-for-consumers/secondary-suite-loan-program',
    summary:
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    scope: 'PROVINCIAL',
    jurisdiction: 'BC',
    sourceUrl: 'https://www.bchousing.org/housing-assistance/home-adaptations',
    summary:
